                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered table-hover record" id="tab_logic">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id='row-1'>
                                                <td name="orderItemsId" value="{{ $loop->index }}">{{ $loop->index+1 }}</td>
                                                        <td><select type="text" name='product[]' id="productList-{{ $ordItems->id }}"
                                                ...
                                                <td><input type="text" name='price[]' id="price-{{ $ordItems->id }}"
